                ...
                <div className="welcome-card" style={{ marginBottom: '24px' }}>
                    <div>
                        ...
                        <p className="welcome-card__subtitle">
                            Mzumbe University — Field Attachment System Management
                        </p>
                    </div>
                                        ...
                                        {filteredUsers.map((u, i) => (
                                            <tr key={u.id} style={{ ...s.tr, background: i % 2 === 0 ? '#fff' : '#f8f9fa' }}>
                                                ...
                                                <td style={{ ...s.td, fontSize: '12px' }}>
                                                    {u.supervisor_name
                                                        ? <span>{u.supervisor_name}{u.supervisor_phone && <><br /><span style={{ color: '#2980b9' }}>📱 {u.supervisor_phone}</span></>}</span>
                                                        : '—'}
                                                </td>
                                                ...
                                                <td style={s.td}>
                                                    <div style={{ display: 'flex', gap: '6px' }}>
                                                        <button onClick={() => { setResetModal({ userId: u.id, userName: u.name }); setNewPassword(''); }}
                                                            style={s.btnBlue} title="Reset Password">🔑</button>
                                                        <button onClick={() => setDeleteModal({ userId: u.id, userName: u.name })}
                                                            style={s.btnRed} title="Delete User">🗑️</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
                        ...
                        <form onSubmit={handleAddUser} className="form">
                            <div style={s.formGrid}>
                                ...
                                <div>
                                    ...
                                    <input type="email" className="form-input"
                                        placeholder="e.g. john@mzumbe.ac.tz"
                                        value={addForm.email}
                            ...
                            {addForm.name && addForm.email && addForm.password && (
                                <div className="alert alert-info" style={{ marginTop: '16px' }}>
                                    <strong>📋 Credentials to Share with User:</strong><br />
